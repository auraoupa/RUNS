...
export NB_NPROC=6523    # number of cores used for NEMO
export NB_NPROC_IOS=113  # number of cores used for xios (number of xios_server.exe)
...
#if [ $n = 1 ] ; then
#   cp $CTL_DIR/namelist.${CONFCASE}_suite $CTL_DIR/namelist.${CONFCASE}
#fi
