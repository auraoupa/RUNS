...
BATFILE_METER=NATL12_bathymetry_20S_80N.nc                                  ; OPA_BATFILE_METER=bathy_meter.nc

# Coordinates
COORDINATES=NATL12_coordinates_20S_80N.nc                                   ; OPA_COORDINATES=coordinates.nc
...
BFR=                                                                        ; OPA_BFR=bfr_coef.nc  # enhanced bottom coef for Torres

# 3D damping mask (aka AABW stuff)
WDMP=                                                                       ; OPA_WDMP=dmp_mask.nc
