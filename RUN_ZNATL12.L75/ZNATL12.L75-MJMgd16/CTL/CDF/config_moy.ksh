...
##  $Id: config_moy.ksh 540 2012-12-19 14:08:40Z molines $
...
TYP_LIST='gridT gridU gridV' # list of grid type
XIOS=      # compute mean values from 5d output . If XIOS not used, set XIOS=
