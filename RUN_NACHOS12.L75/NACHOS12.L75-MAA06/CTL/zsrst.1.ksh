...
#SBATCH --exclusive
 set -x
 cd /scratch/cnt0024/hmg2840/albert7a/TMPDIR_NACHOS12.L75-MAA06
 . ./includefile.ksh
 ...
 for member in $(seq -1 -1) ; do
   ...
   zrstdir='./'
   if [ $RST_DIRS = 1 ] ; then zrstdir=/scratch/cnt0024/hmg2840/albert7a/NACHOS12.L75-MAA06-RST.$ext/$nnn ; fi
