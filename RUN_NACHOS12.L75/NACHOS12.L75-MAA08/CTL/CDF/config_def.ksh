...
CONFIG=NACHOS12.L75
CASE=MAA08
MACHINE=login2.occigen
NODETYPE=BDW28
ulimit -s unlimited  # needed for occigen 

MAIL=aurelie.albert@univ-grenoble-alpes.fr      ## to be edited ##
...
LIM3=1       # if set to 1 use LIM3 ice model and its std output in icemod3. If set to 0 use LIM2 (icemod)
...
#  Sa  #   ATLS          #
##########################
zoomTS=At.Na.Sa #Dr.Ke.Cb.Na.Sa     # 5.2.1 Regional details for temperature and salinity at various depths ( 0 200 1000 2000 3000 4000 5000 ) 
zoomUV=At.Na.Sa #Dr.Ke.Cb.Na.Sa     # 5.2.2 Regional details for Barotropic Stream function (PSI)
zoomFLX=At.Na.Sa #Dr.Ke.Cb          # 5.2.3 Regional details for Air-sea fluxes
zoomMXL=At.Na.Sa #Dr.Ke.Cb          # 5.2.4 Regional details for Mixed Layer depths
zoomICE=At.Na.Sa #Dr.Ke.Cb          # 5.2.5 Regional details for Ice concentration and Ice thickness in march and september
zoomEKE=At.Na.Sa #Dr.Ke.Cb.At.Na.Sa # 5.2.6 Regional details for Eddy Kinetic Energy

coupes=0                 # 6.1 Sections in the global ocean
ar7w=1                   # 6.2 AR7W in the Labrador sea in march and october + Ovide
...
iceplt=1                 # 7.0 Polar plots of ice thickness and concentration
...
mocsig=1                 # 14. Meridional Overturning Circulation in sigma coordinates
cfc=0                    # 15. CFC plots
...
mxls_clim=1              # 17. MXL comparison to Boyer-Montegut climatology
contour=0                # 18. CONTOUR tool
alboran=1                # 19. Surface circulation in the Alboran Sea + salinity
...
ts_cable=1               #  1. timeserie for cable transport (needs TRP = 1)
ts_gib=1                 #  2. timeserie for gibraltar (needs GIB =1)
ts_icemonth=1            #  3. timeserie for ice monthly area, volume, extent (needs ICEMONTH = 1)
...
ts_maxmoc=1              #  6. timeserie for maximum and minimum MOC (needs MAXMOC = 1 and MHT = 1)
