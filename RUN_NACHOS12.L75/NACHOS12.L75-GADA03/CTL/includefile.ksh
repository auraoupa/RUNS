...
SUBMIT_SCRIPT=${CONFIG_CASE}_ada.ksh   # name of the script to be launched by run_nemo in CTL
...
BATFILE_METER=NACHOS12.L75_bathymetry_20S_80N_nfrontiercleaned_repeat3_retouchbalt.nc                                    ; OPA_BATFILE_METER=bathy_meter.nc
