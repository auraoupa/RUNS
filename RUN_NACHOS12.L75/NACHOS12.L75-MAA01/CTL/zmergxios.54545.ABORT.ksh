...
#SBATCH --exclusive
      ...
      . /scratch/cnt0024/hmg2840/albert7a/DEV/RUN_TOOLS/function_3.2_all.ksh
         ...
         zXIOS=/scratch/cnt0024/hmg2840/albert7a/NACHOS12.L75-MAA01-XIOS.54545.ABORT
         WKDIR=$zXIOS/WRK.54545
         mkdir -p $WKDIR
         cd $WKDIR
         ...
         for member in $(seq  -1 -1 ) ; do
            ...
            ln -sf $zXIOS/$nnn/NACHOS12.L75-MAA01*.nc ./
         done
         ...
         for idx in $( seq 0 $idxmax ) ; do
             runcode_u 5 ./$mergeprog -f ${lst0000[$idx]} -c coordinates.nc -r
         done
         \rm *.nc  # in WKDIR
